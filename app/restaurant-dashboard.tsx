    ...
    <View style={styles.container}>
      ...
      <View style={styles.tabsContainer}>
        ...
        >
          <Store
            size={20}
            color={activeTab === "overview" ? colors.primary : colors.lightText}
          />
          <Text
            style={[
              styles.tabText,
        ...
        >
          <Menu
            size={20}
            color={activeTab === "menu" ? colors.primary : colors.lightText}
          />
          <Text
            style={[
              styles.tabText,
        ...
        >
          <Package
            size={20}
            color={activeTab === "orders" ? colors.primary : colors.lightText}
          />
          <Text
            style={[
              styles.tabText,
        ...
        >
          <Settings
            size={20}
            color={activeTab === "settings" ? colors.primary : colors.lightText}
          />
          <Text
            style={[
              styles.tabText,
